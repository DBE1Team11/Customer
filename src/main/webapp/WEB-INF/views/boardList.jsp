...
<div id="menu">
    ...
    <script>
        ...
        if(msg == "DEL_ERR") alert("삭제를 실패하였습니다.");
        if(msg == "WRT_OK") alert("성공적으로 작성되었습니다.");
    ...
    <table border="1">
        ...
        <c:forEach var="boardDto" items="${list}">
            <tr>
                <td>${boardDto.bno}</td>
                <td><a href="<c:url value='read?bno=${boardDto.bno}&page=${page}&pageSize=${pageSize}'/>">${boardDto.title}</a></td>
